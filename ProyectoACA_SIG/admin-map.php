        ...
        for (i = 0; i < locations.length; i++) {
            ...
            google.maps.event.addListener(marker, 'click', (function(marker, i) {
                return function() {
                    ...
                    $("#organizador").val(locations[i][3]);
                    $("#fecha").val(locations[i][4]);
                    $("#meta").val(locations[i][5]);
                    $("#form").show();
...
<div style="display: none" id="form">
    <table class="map1">
        <tr>
            ...
            <td><a>Organizador:</a></td>
            <td><textarea disabled id='organizador' placeholder='Organizador'></textarea></td>
        </tr>
        <tr>
            <td><a>Fecha:</a></td>
            <td><textarea disabled id='fecha' placeholder='Fecha'></textarea></td>
        </tr>
        <tr>
            <td><a>Meta:</a></td>
            <td><textarea disabled id='meta' placeholder='Meta'></textarea></td>
        </tr>
        <tr>
