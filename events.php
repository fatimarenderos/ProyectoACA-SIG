          ...
          <?php while ($fila = $resultado->fetch_assoc()) { ?>
              ...
              <div class="card border-success mb-3  text-center" style="max-width: 18rem;">
                  ...
                  <div class="card-body text-success">
                    ...
                    <a href="editar.php?id=<?php echo $fila['id']; ?>"class="btn btn-outline-success">Editar</a>
                    <a href="eliminar.php?id=<?php echo $fila['id']; ?>"class="btn btn-outline-warning">Eliminar</a>
                  </div> 
